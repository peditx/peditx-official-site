...
# ==========================================
# OpenWrt Home Assistant Installer
# Auto-Start + Firewall + UI Menu
# ==========================================
...
mkdir -p "$CONFIG_DIR"
# No chmod needed usually for HA in host mode, but good practice
...
function index()
    -- Rank 10 places it at the very top of PeDitXOS menu
...
echo -e "\nSUCCESS! Home Assistant & Menu Installed."
