...
# ==========================================
# OpenWrt Homebridge Uninstaller
# Removes Container, Firewall & Menu
# ==========================================

echo -e "\n--- Homebridge Uninstaller ---\n"
...
rm -f /usr/lib/lua/luci/controller/peditxos_homebridge.lua
rm -f /usr/lib/lua/luci/view/peditxos/homebridge.htm
